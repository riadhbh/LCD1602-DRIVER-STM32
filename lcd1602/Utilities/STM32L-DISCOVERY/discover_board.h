...
#define LED_G1_4 		GPIO_Pin_11
#define LED_R2_3		GPIO_Pin_12

#define LD_GPIO_PORT_CLKA             RCC_AHBPeriph_GPIOA


#define GPIO_B 		GPIOB
#define LED_O2_3		GPIO_Pin_6
#define LED_O1_4	        GPIO_Pin_7
#define LD_GPIO_PORT_CLKB             RCC_AHBPeriph_GPIOB


#define GPIO_D 		GPIOD
#define LED_G2_3		GPIO_Pin_2
#define LD_GPIO_PORT_CLKD             RCC_AHBPeriph_GPIOD

#define CTN_GPIO_PORT           GPIOC
#define LED_R1_4                GPIO_Pin_12
#define CTN_CNTEN_GPIO_PIN      GPIO_Pin_13
#define CTN_GPIO_CLKC            RCC_AHBPeriph_GPIOC
