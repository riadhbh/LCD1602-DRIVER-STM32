...
#define STR_VERSION     tab[1] = 'V';tab[2] = '2'|DOT; tab[3] = '0'|DOT; tab[4] = '0'
...
#define AUTOTEST(a) DATA_EEPROM_Unlock();   DATA_EEPROM_FastProgramByte((uint32_t)&Auto_test,a ) ;  DATA_EEPROM_Lock()	
